...
/**
 * errorEnv - Creates an error message for env errors.
...
/**
 * error1 - Creates an error message for alias errors.
 * @args: An array of arguments passed to the command.
 *
 * Return: The error string.
 */
...
/**
 * errorToExit - Creates an error message for exit errors.
 * @args: An array of arguments passed to the command.
 *
 * Return: The error string.
 */
...
/**
 * errorToCd - Creates an error message for shellby_cd errors.
 * @args: An array of arguments passed to the command.
 *
 * Return: The error string.
 */
...
/**
 * syntaxError - Creates an error message for syntax errors.
 * @args: An array of arguments passed to the command.
 *
 * Return: The error string.
 */
